...
//	double pmass = 1.02732 * 1e9; // N1100 250 Mpc/h (z=1.5,0.4, 0.9)
	double pmass = 3.04392 * 1e8; // N1650 250 Mpc/h (z=1.5,0.4,0.9)
//	double pmass = 5.06432 * 1e7; // N3000 250 Mpc/h (z=1.5)
//	double pmass = 1.59183 * 1e8; // N2048 250 Mpc/h (z=0.4)
...
//							printf("t_delay: %lf\n", t_delay);
							...
							double m = -0.43;
							double c = 4.94;
							double x = log10(mstar/cosm.hubble);
...
double mhalo2mstar(Cosmology cosm, double M_halo_msun_h, double z)
{
	// Moster et al. 2012 eq. 2, table 1
